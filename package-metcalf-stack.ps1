...
$Files = @(
    ...
    @("requirements-metcalf-stack.txt", "requirements.txt"),
    @("run-metcalf-stack.cmd", "run-metcalf-stack.cmd"),
    @("run-metcalf-stack-drop.cmd", "run-metcalf-stack-drop.cmd"),
    ...
    @("LICENSE", "LICENSE"),
    @("metcalf-stack.gitignore", ".gitignore"),
